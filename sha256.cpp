...
{
	string message = "amitrao042";

	srand((unsigned)time(0));
    int random_integer = rand() % 1000000007;
	...
	while(hash[0] <= 57 && hash[0] >= 48){

	message = "amitrao042";

	srand((unsigned)time(0));
    random_integer = rand() % 1000000007;
	...
	cout << random_integer << "     " << hash << "      " << message <<endl;
	return 0;
}
